...
export default function CartLayaut({ IconContainer }) {
      ...
      <div key={item.id} className={c.wrapper}>
        <section className={c.pageLeft}>
          <div className={c.pageAvatar}>
            ...
            <div title="Добавить врача в избранное" className={c.buttonLike}></div>
          </div>
          ...
          <div className={c.pageCardInfo}>
            <div className={c.infoBlock}>
              ...
              <div className={c.details}>
                ...
                <span className={c.detailsCategory}>{item.doctorCategory}</span>
              </div>
            ...
            <div className={c.clinicInfo}>
              <div className={c.clinicAppointments}>
                <div className={c.wrapper}>
                  <div className={c.items}>
                    <div className={c.itemCaption}>Выберите время приёма для записи онлайн</div>
                    <div className={c.slotsDays}>
                      <div className={c.slotsBtns}>
                        <button className={classes.filterButton}>{item.appointmentCalendar}</button>
                        <button className={classes.filterBtns}>{item.appointmentCalendar2}</button>
                        <button className={classes.filterBtn}>{item.appointmentCalendar3}</button>
                      </div>
                    </div>
              ...
              <div className={c.clinicLocation}>
                <div className={c.addressBlock}>
                  <div className={classes.city}>{item.address}</div>
  ...
  return <div className={c.doctorContainer}>{getDataSpecialist}</div>;
}
